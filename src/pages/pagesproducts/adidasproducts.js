...
class AdidasProducts extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataGender: null,
  ...
  render() {
    ...
    if (dataGender && dataPrice) {
      ListeProduitFiltered = (
        <ListeProduit brand={"adidas"} gender={dataGender} price={dataPrice} />
      );
    } else if (dataGender && !dataPrice) {
      ListeProduitFiltered = (
        <ListeProduit brand={"adidas"} gender={dataGender} />
      );
    } else if (!dataGender && dataPrice) {
      ListeProduitFiltered = (
        <ListeProduit brand={"adidas"} price={dataPrice} />
      );
    } else {
      ListeProduitFiltered = <ListeProduit brand={"adidas"} />;
    }
    return (
      <Fragment>
        <section id="bandeau">
          <img src="assets/bandeau/adidas.png" alt="adidas Bandeau" />
        </section>
